...
- 2026-06-02: Enabled automatic Gmail notifications for payment success. Added customerId metadata to PAYMENT_PROCESSED in payment.handler.ts, created notification-service/.env with Gmail SMTP credentials, installed missing nodemailer packages, and verified clean TypeScript builds for both services.
